...
class Zarinpal
{
     ...
     * @return array
     */
    public function request($Amount, $Description="",$Email="", $Mobile="", $CallbackURL, $SandBox=false, $ZarinGate=false)
    {
     ...
     * @throws \SoapFault
     */
    public function verify($Amount , $au , $SandBox=false, $ZarinGate=false)
    {
        $ZarinGate = ($SandBox == true) ? false : $ZarinGate;
